...
struct TalkIntent: AppIntent {
    static var title: LocalizedStringResource = "Hablar con Rasputina"
    static var description = IntentDescription("Abre OpenClock y empieza a grabar de inmediato.")
...
struct OpenClockShortcuts: AppShortcutsProvider {
